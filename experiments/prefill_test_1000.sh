#!/usr/bin/env bash
# experiments/prefill_test_1000.sh
#
# Prefill stress test: colocated vs 1p1d disaggregated across short input lengths.
...
#   bash experiments/prefill_test_1000.sh configs/prefill_test_1000.env
...
OUTDIR="$SCRATCH/disaggregated-prefill-decode-research/results/prefill_test_1000"

SWEEP_CONFIG="${1:-$REPO_ROOT/configs/prefill_test_1000.env}"
source "$SWEEP_CONFIG"
...
echo "Starting prefill test 1000: $TOTAL total runs."
...
echo ""
echo "Prefill test 1000 complete. Results in $OUTDIR"
echo "Run: python utils/plot_prefill_test_1000.py to generate plots."
